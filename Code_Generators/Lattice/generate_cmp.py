...
from entities.common import (
    Author, Category, Created, Deprecated, Description, Keywords,
    Name, Position, Rotation, Version
)
...
def generate_cmp(
    ...
    variant = Variant(uuid_variant_default, Norm.EMPTY, Name('default'), Description(''))
    ...
    if uuid_symbol_default != uuid_symbol_variant:
        ...
        iunits = int(units)
        variant = Variant(uuid_variant_variant, Norm.EMPTY, Name('{}'.format(variant_name)), Description(''))
